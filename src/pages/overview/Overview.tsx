    ...
    return (
        <main className="overview bg-gradient-to-r from-sanJuan to-eastBay dark">
            ...
            <section className="container mx-auto mt-5">
                ...
                <button className="px-4 py-2 bg-indigo-700 dark:text-white hover:bg-indigo-600 rounded-md shadow-md hover:shadow-lg" onClick={e => dispatch(increment())}>Add new project</button>
